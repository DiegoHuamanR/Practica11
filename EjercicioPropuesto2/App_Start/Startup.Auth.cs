...
using Owin;
using EjercicioPropuesto2.Models;
...
namespace EjercicioPropuesto2
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            {
                ClientId = "247362751187-2lid0sjoclebbsauq1fem8a4g5ks7872.apps.googleusercontent.com",
                ClientSecret = "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"
            });
        }
    }
}